resource "aws_instance" "ec2_client_in_public_subnet_vpc1" {
  ...
  tags = {
    Name = "ec2_client_in_public_subnet_vpc1"
  }
}

resource "aws_instance" "ec2_server_in_public_subnet_vpc1" {
  ami                         = var.var_ec2_amazon_linux
  instance_type               = var.var_instance_types
  subnet_id                   = aws_subnet.subnet_public_az1a_vpc1.id
  key_name                    = var.var_keypair
  ...
  tags = {
    Name = "ec2_server_in_public_subnet_vpc1"
  }
}
